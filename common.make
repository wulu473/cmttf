...
CXXFLAGS+= -Xcompiler -Wall -Xcompiler -Wextra -Xcompiler -Wshadow -Xcompiler -Wpointer-arith -Xcompiler -Wcast-qual -std=c++11 -g -Xcompiler -fopenmp -O3 -Xcompiler
CXXFLAGS_DEBUG+= -Xcompiler -Wall -Xcompiler -Wextra -Xcompiler -Wshadow -Xcompiler -Wpointer-arith -Xcompiler -Wcast-qual -std=c++11 -g -Xcompiler -fopenmp -O0 -DDEBUG -Xcompiler
...
LDLIBS+=-lboost_unit_test_framework -lboost_log -lcublas -lcusolver -lcusparse -lcuda -lboost_program_options -lconfig++ -lboost_system
