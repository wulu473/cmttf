...
class System : public SystemBase
{
  public:
    ...
    State FLinear(const StencilArray& /*states_new*/, const StencilArray& /*states_old*/,
    ...
    StencilJacobian JLinear(const StencilArray& /*states_new*/, const StencilArray& /*states_old*/,
                            const real /*dx*/, const real /*x*/, const real /*t*/) const
        {throw NotImplemented();}
