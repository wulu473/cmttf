...
J(0,1) = (1.0L/8.0L)*g1*pow(u_1_0, 2)/(dx*mu) + (1.0L/4.0L)*g1*u_1_0*u_2_0/(dx*mu) + (1.0L/8.0L)*g1*pow(u_2_0, 2)/(dx*mu) - 1.0L/4.0L*tau*u_1_0/(dx*mu) - 1.0L/4.0L*tau*u_2_0/(dx*mu) + (1.0L/6.0L)*g2*pow(u_1_0, 3)/(pow(dx, 2)*mu) + (1.0L/4.0L)*g2*pow(u_1_0, 2)*u_2_0/(pow(dx, 2)*mu) - 1.0L/12.0L*g2*pow(u_2_0, 3)/(pow(dx, 2)*mu) + (1.0L/8.0L)*sigma*u_0_0*pow(u_1_0, 2)/(pow(dx, 4)*mu) + (1.0L/4.0L)*sigma*u_0_0*u_1_0*u_2_0/(pow(dx, 4)*mu) + (1.0L/8.0L)*sigma*u_0_0*pow(u_2_0, 2)/(pow(dx, 4)*mu) - 1.0L/2.0L*sigma*pow(u_1_0, 3)/(pow(dx, 4)*mu) - 3.0L/4.0L*sigma*pow(u_1_0, 2)*u_2_0/(pow(dx, 4)*mu) - 1.0L/8.0L*sigma*pow(u_1_0, 2)*u_3_0/(pow(dx, 4)*mu) - 1.0L/4.0L*sigma*u_1_0*u_2_0*u_3_0/(pow(dx, 4)*mu) + (5.0L/24.0L)*sigma*pow(u_2_0, 3)/(pow(dx, 4)*mu) - 1.0L/4.0L*sigma*pow(u_2_0, 2)*u_3_0/(pow(dx, 4)*mu) - 1.0L/8.0L*sigma*u_2_0*pow(u_3_0, 2)/(pow(dx, 4)*mu) - 1.0L/24.0L*sigma*pow(u_3_0, 3)/(pow(dx, 4)*mu);
J(0,2) = (1.0L/8.0L)*g1*pow(u_1_0, 2)/(dx*mu) + (1.0L/4.0L)*g1*u_1_0*u_2_0/(dx*mu) - 1.0L/4.0L*g1*u_2_0*u_3_0/(dx*mu) - 1.0L/8.0L*g1*pow(u_3_0, 2)/(dx*mu) - 1.0L/4.0L*tau*u_1_0/(dx*mu) + (1.0L/4.0L)*tau*u_3_0/(dx*mu) + (1.0L/12.0L)*g2*pow(u_1_0, 3)/(pow(dx, 2)*mu) - 1.0L/4.0L*g2*u_1_0*pow(u_2_0, 2)/(pow(dx, 2)*mu) - 1.0L/3.0L*g2*pow(u_2_0, 3)/(pow(dx, 2)*mu) - 1.0L/4.0L*g2*pow(u_2_0, 2)*u_3_0/(pow(dx, 2)*mu) + (1.0L/12.0L)*g2*pow(u_3_0, 3)/(pow(dx, 2)*mu) + (1.0L/8.0L)*sigma*u_0_0*pow(u_1_0, 2)/(pow(dx, 4)*mu) + (1.0L/4.0L)*sigma*u_0_0*u_1_0*u_2_0/(pow(dx, 4)*mu) + (1.0L/8.0L)*sigma*u_0_0*pow(u_2_0, 2)/(pow(dx, 4)*mu) - 1.0L/4.0L*sigma*pow(u_1_0, 3)/(pow(dx, 4)*mu) - 1.0L/8.0L*sigma*pow(u_1_0, 2)*u_3_0/(pow(dx, 4)*mu) + (5.0L/8.0L)*sigma*u_1_0*pow(u_2_0, 2)/(pow(dx, 4)*mu) - 1.0L/2.0L*sigma*u_1_0*u_2_0*u_3_0/(pow(dx, 4)*mu) - 1.0L/8.0L*sigma*u_1_0*pow(u_3_0, 2)/(pow(dx, 4)*mu) + sigma*pow(u_2_0, 3)/(pow(dx, 4)*mu) + (5.0L/8.0L)*sigma*pow(u_2_0, 2)*u_3_0/(pow(dx, 4)*mu) + (1.0L/8.0L)*sigma*pow(u_2_0, 2)*u_4_0/(pow(dx, 4)*mu) + (1.0L/4.0L)*sigma*u_2_0*u_3_0*u_4_0/(pow(dx, 4)*mu) - 1.0L/4.0L*sigma*pow(u_3_0, 3)/(pow(dx, 4)*mu) + (1.0L/8.0L)*sigma*pow(u_3_0, 2)*u_4_0/(pow(dx, 4)*mu);
J(0,3) = -1.0L/8.0L*g1*pow(u_2_0, 2)/(dx*mu) - 1.0L/4.0L*g1*u_2_0*u_3_0/(dx*mu) - 1.0L/8.0L*g1*pow(u_3_0, 2)/(dx*mu) + (1.0L/4.0L)*tau*u_2_0/(dx*mu) + (1.0L/4.0L)*tau*u_3_0/(dx*mu) - 1.0L/12.0L*g2*pow(u_2_0, 3)/(pow(dx, 2)*mu) + (1.0L/4.0L)*g2*u_2_0*pow(u_3_0, 2)/(pow(dx, 2)*mu) + (1.0L/6.0L)*g2*pow(u_3_0, 3)/(pow(dx, 2)*mu) - 1.0L/24.0L*sigma*pow(u_1_0, 3)/(pow(dx, 4)*mu) - 1.0L/8.0L*sigma*pow(u_1_0, 2)*u_2_0/(pow(dx, 4)*mu) - 1.0L/4.0L*sigma*u_1_0*pow(u_2_0, 2)/(pow(dx, 4)*mu) - 1.0L/4.0L*sigma*u_1_0*u_2_0*u_3_0/(pow(dx, 4)*mu) - 1.0L/8.0L*sigma*u_1_0*pow(u_3_0, 2)/(pow(dx, 4)*mu) + (5.0L/24.0L)*sigma*pow(u_2_0, 3)/(pow(dx, 4)*mu) + (1.0L/8.0L)*sigma*pow(u_2_0, 2)*u_4_0/(pow(dx, 4)*mu) - 3.0L/4.0L*sigma*u_2_0*pow(u_3_0, 2)/(pow(dx, 4)*mu) + (1.0L/4.0L)*sigma*u_2_0*u_3_0*u_4_0/(pow(dx, 4)*mu) - 1.0L/2.0L*sigma*pow(u_3_0, 3)/(pow(dx, 4)*mu) + (1.0L/8.0L)*sigma*pow(u_3_0, 2)*u_4_0/(pow(dx, 4)*mu);
...
//  const real g1 = m_g1;
  const real g2 = m_g2;
//  const real tau = m_tau(t,x); (not dependent on tau)

  // F should be linear in states_new. J is therefore not dependent on states_new

//  const real u0_0_0 = states_old[0][0]; ( not dependent unt u0_0_0)
  const real u0_1_0 = states_old[1][0];
  const real u0_2_0 = states_old[2][0];
  const real u0_3_0 = states_old[3][0];
//  const real u0_4_0 = states_old[4][0];
...
J_lin(0,1) = (1.0L/24.0L)*g2*pow(u0_1_0, 3)/(pow(dx, 2)*mu) + (1.0L/8.0L)*g2*pow(u0_1_0, 2)*u0_2_0/(pow(dx, 2)*mu) + (1.0L/8.0L)*g2*u0_1_0*pow(u0_2_0, 2)/(pow(dx, 2)*mu) + (1.0L/24.0L)*g2*pow(u0_2_0, 3)/(pow(dx, 2)*mu) - 1.0L/8.0L*sigma*pow(u0_1_0, 3)/(pow(dx, 4)*mu) - 3.0L/8.0L*sigma*pow(u0_1_0, 2)*u0_2_0/(pow(dx, 4)*mu) - 3.0L/8.0L*sigma*u0_1_0*pow(u0_2_0, 2)/(pow(dx, 4)*mu) - 1.0L/6.0L*sigma*pow(u0_2_0, 3)/(pow(dx, 4)*mu) - 1.0L/8.0L*sigma*pow(u0_2_0, 2)*u0_3_0/(pow(dx, 4)*mu) - 1.0L/8.0L*sigma*u0_2_0*pow(u0_3_0, 2)/(pow(dx, 4)*mu) - 1.0L/24.0L*sigma*pow(u0_3_0, 3)/(pow(dx, 4)*mu);
J_lin(0,2) = -1.0L/24.0L*g2*pow(u0_1_0, 3)/(pow(dx, 2)*mu) - 1.0L/8.0L*g2*pow(u0_1_0, 2)*u0_2_0/(pow(dx, 2)*mu) - 1.0L/8.0L*g2*u0_1_0*pow(u0_2_0, 2)/(pow(dx, 2)*mu) - 1.0L/12.0L*g2*pow(u0_2_0, 3)/(pow(dx, 2)*mu) - 1.0L/8.0L*g2*pow(u0_2_0, 2)*u0_3_0/(pow(dx, 2)*mu) - 1.0L/8.0L*g2*u0_2_0*pow(u0_3_0, 2)/(pow(dx, 2)*mu) - 1.0L/24.0L*g2*pow(u0_3_0, 3)/(pow(dx, 2)*mu) + (1.0L/8.0L)*sigma*pow(u0_1_0, 3)/(pow(dx, 4)*mu) + (3.0L/8.0L)*sigma*pow(u0_1_0, 2)*u0_2_0/(pow(dx, 4)*mu) + (3.0L/8.0L)*sigma*u0_1_0*pow(u0_2_0, 2)/(pow(dx, 4)*mu) + (1.0L/4.0L)*sigma*pow(u0_2_0, 3)/(pow(dx, 4)*mu) + (3.0L/8.0L)*sigma*pow(u0_2_0, 2)*u0_3_0/(pow(dx, 4)*mu) + (3.0L/8.0L)*sigma*u0_2_0*pow(u0_3_0, 2)/(pow(dx, 4)*mu) + (1.0L/8.0L)*sigma*pow(u0_3_0, 3)/(pow(dx, 4)*mu);
J_lin(0,3) = (1.0L/24.0L)*g2*pow(u0_2_0, 3)/(pow(dx, 2)*mu) + (1.0L/8.0L)*g2*pow(u0_2_0, 2)*u0_3_0/(pow(dx, 2)*mu) + (1.0L/8.0L)*g2*u0_2_0*pow(u0_3_0, 2)/(pow(dx, 2)*mu) + (1.0L/24.0L)*g2*pow(u0_3_0, 3)/(pow(dx, 2)*mu) - 1.0L/24.0L*sigma*pow(u0_1_0, 3)/(pow(dx, 4)*mu) - 1.0L/8.0L*sigma*pow(u0_1_0, 2)*u0_2_0/(pow(dx, 4)*mu) - 1.0L/8.0L*sigma*u0_1_0*pow(u0_2_0, 2)/(pow(dx, 4)*mu) - 1.0L/6.0L*sigma*pow(u0_2_0, 3)/(pow(dx, 4)*mu) - 3.0L/8.0L*sigma*pow(u0_2_0, 2)*u0_3_0/(pow(dx, 4)*mu) - 3.0L/8.0L*sigma*u0_2_0*pow(u0_3_0, 2)/(pow(dx, 4)*mu) - 1.0L/8.0L*sigma*pow(u0_3_0, 3)/(pow(dx, 4)*mu);
